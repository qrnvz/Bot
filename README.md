...
#quiz - "#quiz start" or "quiz start en" starts the quiz, sends new question every 5 minutes, gives 1 minute to answer, "#quiz stop" stops the quiz ("#quiz start ru" для запуска викторины на русском языке);
